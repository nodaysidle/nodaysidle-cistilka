...
BUNDLE_ID=${BUNDLE_ID:-com.nodaysidle.cistilka}
...
# version.env may use VERSION= or MARKETING_VERSION=
...
<dict>
    ...
    <string>Cistilka connects over the local network when you scan SSH/SFTP paths on devices in your LAN.</string>
    <!-- OAuth redirect schemes for ASWebAuthenticationSession (Google / Microsoft).
         Google: ${BUNDLE_ID}; Microsoft msauth.${BUNDLE_ID} (Config/OAuth.plist). -->
